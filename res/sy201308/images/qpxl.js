...
var gg960Con;
var fullAdType = 'jpg';
var fullAdUrl = 'http://www.ntradio.net/ReadNews.asp?NewsID=28084'
var fullAdName = 'images/qpad.swf';;
if(fullAdName)
{
	if(fullAdType == 'jpg')
	{
		gg960Con = '<a href="'+fullAdUrl+'" target="_blank"><img width="1000" height="400" src="http://www.ntjoy.com/images/ad/jhfq_pb.jpg"/></a>';//flash无法显示时，显示JPG广告
	}
